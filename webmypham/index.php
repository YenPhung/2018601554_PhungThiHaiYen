                    ...
                    <div class="col-lg-9 col-md-12 padding-fix-l20">
                        ...
                        <div class="slider-btm-box d-flex justify-content-around">
                            <div class="single-box mr-20">
                                <a href="#"><img src="images/1646876327955-set-duong-innisfree-green-tea-balancing-skin-care-trio-ex-300x300.jpeg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="single-box mr-20">
                                <a href="#"><img src="images/1608520048192-set-huxley-antioxidant-trio-chong-lao-hoa-300x300.jpeg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="single-box">
                                <a href="#"><img src="images/1608532499607-set-huxley-extra-moisture-trio-duong-am-cho-da-kho-300x300.png" alt="" class="img-fluid"></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="bt-deal">
                                    ...
                                    <div class="bt-body owl-carousel">
                                        <div class="bt-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham ORDER BY luotxem ASC LIMIT 4") as $item) {
                                                    ?>
                                ...
                                <div class="hm-test">
                                    <div class="test-body owl-carousel">
                                        <div class="test-item text-center">
                                            ...
                                            <h6>Hồng Ngọc</h6>
                                            <span>Người Mẫu</span>
                                            <p>"Sự kết hợp giữa hai màu hồng và tím lại pha chút nâu nhẹ. Các nàng bánh bèo muốn có một chút phá cách sẽ rất thích màu này."</p>
                                        </div>
                                        <div class="test-item text-center">
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="row">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="all" role="tabpanel">
                                            <div class="tab-slider owl-carousel">
                                                <?php 
                                                    foreach (selectAll("SELECT * FROM sanpham") as $item) {
                                                        ?>
                                                            <div class="tab-item">
                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="new-product">
                                    ...
                                    <div class="new-slider owl-carousel">
                                        <?php 
                                            foreach (selectAll("SELECT * FROM sanpham ORDER BY id DESC LIMIT 10") as $item) {
                                               ?>
                                                <div class="new-item">
                                                    <div class="tab-heading">
                                                        <!-- <ul class="list-unstyled list-inline">
                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="top-slr">
                                    <div class="sec-title">
                                        <h5>Giảm giá cực hot</h5>
                                    </div>
                                    <div class="slr-slider owl-carousel">
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=1 LIMIT 3") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                                            </div>
                                                            <div class="slr-content">
                                                                <p style="display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;word-break: break-word;"><a href="chitiet.php?id=<?= $item['id'] ?>"><?= $item['ten'] ?></a></p>
                                                                <ul class="list-unstyled list-inline fav">
                                                                    <li class="list-inline-item"><i class="fa fa-star"></i></li>
                                                                    <li class="list-inline-item"><i class="fa fa-star"></i></li>
                                                                    <li class="list-inline-item"><i class="fa fa-star"></i></li>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=3 LIMIT 3") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=7 LIMIT 3") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=6 LIMIT 3") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="hm-blog">
                                    ...
                                    <div class="blog-slider owl-carousel">
                                        <div class="blog-item">
                                            <div class="blog-img">
                                                <a href="#"><img style="width:248px;height:195px;object-fit:cover" src="images/1646794281922-trang-diem-mat-dep-600x600.png" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="blog-content">
                                                <h6><a href="#">Hướng dẫn cách trang điểm mắt đẹp tự nhiên cho nàng</a></h6>
                                                <ul class="list-unstyled list-inline">
...
">Đôi mắt là cửa sổ của tâm hồn, trang điểm mắt không những giúp cho khuôn mặt bạn có chiều sâu và đặc biệt có sức hút với người đối diện. Những bạn nữ yêu thích phong cách nhẹ nhàng, không quá cầu kỳ thì đừng bỏ qua cách trang điểm mắt đẹp tự nhiên dưới đây của Cocolux nhé!</p>
                                            </div>
                                        </div>
                                        <div class="blog-item">
                                            <div class="blog-img">
                                                <a href="#"><img style="width:248px;height:195px;object-fit:cover" src="images/1646724998187-bot-tra-xanh-1-600x600.jpeg" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="blog-content">
                                                <h6><a href="#">Tác dụng của bột trà xanh trong chăm sóc da</a></h6>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item"><i class="fa fa-calendar"></i>17/3/2022</li>
                                                </ul>
                                                <p style="display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;word-break: break-word;
">Trà xanh là một thức uống có lợi rất nhiều cho sức khỏe. Bên cạnh đó, trà xanh còn là một nguyên liệu hữu hiệu trong làm đẹp và chăm sóc da. Bột trà xanh cung cấp nhiều chất dinh dưỡng cho làm da giúp da chắc khỏe, mịn màng, ngăn ngừa lão hoá. Hãy cùng Cocolux tìm hiểu chi tiết về tác dụng của bột trà xanh cũng như những công thức chăm sóc da với bột trà xanh.</p>
                                            </div>
                                        </div>
                                        <div class="blog-item">
                                            <div class="blog-img">
                                                <a href="#"><img style="width:248px;height:195px;object-fit:cover" src="images/1646454191149-bha-cho-nguoi-moi-bat-dau-3-500x500.jpeg" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="blog-content">
                                                <h6><a href="#">Hướng dẫn sử dụng BHA hiệu quả cho người mới bắt đầu</a></h6>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item"><i class="fa fa-calendar"></i>17/3/2022</li>
                                                </ul>
                                                <p style="display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;word-break: break-word;
">BHA thành phần “vàng” trong hỗ trợ điều trị những vấn đề trên da như các loại mụn, cải thiện tình trạng lỗ chân lông, tẩy da chết. Nhưng đây là một hoạt chất hoạt động mạnh người sử dụng cần phải lưu ý. Trong bài viết này Cocolux sẽ hướng dẫn chi tiết nhất cách dùng BHA cho người mới bắt đầu để mang lại hiệu quả tốt nhất, cùng theo dõi nhé!</p>
                                            </div>
                                        </div>
                                        <div class="blog-item">
                                            <div class="blog-img">
                                                <a href="#"><img style="width:248px;height:195px;object-fit:cover" src="images/1646453876034-kem-chong-nang-nang-tone-2-500x500.jpeg" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="blog-content">
                                                <h6><a href="#">Gợi ý cho nàng 5 loại kem chống nắng nâng tone</a></h6>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item"><i class="fa fa-calendar"></i>17/3/2022</li>
                                                </ul>
                                                <p style="display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;word-break: break-word;
">
Kem chống nắng được biết đến với với công dụng bảo vệ làn da bạn khỏi những tác nhân gây hại như ánh nắng, môi trường… Trên thị trường mỹ phẩm hiện nay đã có rất nhiều kem chống nắng tích hợp giữa chống nắng và trang điểm vô cùng tiện lợi. Cùng Cocolux tham khảo 5 loại kem chống nắng nâng tone đang được yêu thích trên thị trường nhé!
</p>
                                            </div>
                                        </div>
                                    </div>
