                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="top-slr">
                                    ...
                                    <div class="slr-slider owl-carousel">
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=1 and giakm > 0 LIMIT 5") as $item) {
                                                    ?>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=3 and giakm > 0 LIMIT 5") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=7 and giakm > 0 LIMIT 5") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=6 and giakm > 0 LIMIT 5") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
                                        ...
                                        <div class="slr-items">
                                            <?php 
                                                foreach (selectAll("SELECT * FROM sanpham WHERE id_danhmuc=9 and giakm > 0 LIMIT 5") as $item) {
                                                    ?>
                                                        <div class="slr-box d-flex">
                                                            <div class="slr-img">
                                                                <a href="chitiet.php?id<?= $item['id'] ?>"><img src="images/<?= $item['anh1'] ?>" style="width: 85px;height: 85px;" alt=""></a>
